...
//  2024-01-09: OpenGL: Update GL3W based imgui_impl_opengl3_loader.h to load "libGL.so" and variants, fixing regression
//  on distros missing a symlink. 2023-11-08: OpenGL: Update GL3W based imgui_impl_opengl3_loader.h to load "libGL.so"
//  instead of "libGL.so.1", accommodating for NetBSD systems having only "libGL.so.3" available. (#6983) 2023-10-05:
//  OpenGL: Rename symbols in our internal loader so that LTO compilation with another copy of gl3w is possible. (#6875,
//  #6668, #4445) 2023-06-20: OpenGL: Fixed erroneous use glGetIntegerv(GL_CONTEXT_PROFILE_MASK) on contexts lower
//  than 3.2. (#6539, #6333) 2023-05-09: OpenGL: Support for glBindSampler() backup/restore on ES3. (#6375) 2023-04-18:
//  OpenGL: Restore front and back polygon mode separately when supported by context. (#6333) 2023-03-23: OpenGL:
//  Properly restoring "no shader program bound" if it was the case prior to running the rendering function. (#6267,
//  #6220, #6224) 2023-03-15: OpenGL: Fixed GL loader crash when GL_VERSION returns NULL. (#6154, #4445, #3530)
