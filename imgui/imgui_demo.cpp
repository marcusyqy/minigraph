...
// - In Visual Studio: CTRL+comma ("Edit.GoToAll") can follow symbols in comments, whereas CTRL+F12
    ...
    if (ImGui::TreeNode("Horizontal scrolling")) {
        ...
        if (ImGui::BeginTable("table_scrollx", 7, flags, outer_size)) {
            ...
            ImGui::TableSetupColumn(
                "Line #",
                ImGuiTableColumnFlags_NoHide); // Make the first column not hideable to match our use of
